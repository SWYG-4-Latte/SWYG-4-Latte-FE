      ...
      <main className="relative pt-14 text-gray10">
        ...
        <aside className="mt-4 w-full bg-primaryBeige px-5 py-8">
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            <div>
              <p className={cn('mb-1 text-center text-[18px] font-bold leading-[27px]', liked && 'mb-4')}>
                {liked ? (
            ...
            {!liked && (
              <button
                ...
                className="flex items-center rounded-lg bg-primaryOrange px-4 py-2 text-[14px] font-medium text-gray00"
              >
                <Image
