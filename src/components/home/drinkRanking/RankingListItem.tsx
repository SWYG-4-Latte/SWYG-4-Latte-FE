    ...
    >
      ...
      <div className="relative ml-auto">
        ...
        {isTooltipOpen && ranking === 1 && (
          <div className="absolute -right-2 z-10 h-[52px] w-[164px]">
            <p className="absolute top-2 z-10 px-4 py-2 text-xs leading-[18px] text-gray00">
              오늘 마신 카페인으로
              <br /> 바로 추가할 수 있어요.
            </p>
            <button
              className="absolute right-4 top-4 z-10 h-4 w-4"
              onClick={(e) => {
                e.stopPropagation();
