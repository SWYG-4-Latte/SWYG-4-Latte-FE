...
const CaffeineComparisonContainer = ({ menuNo }: { menuNo: number }) => {
  ...
  return (
    <div className="bg-primaryIvory px-5 pb-6 pt-4 ">
      <div className="mb-3 flex items-center justify-between">
        ...
        <button className="flex h-[30px] w-[97px] items-center whitespace-nowrap rounded-md border border-gray05 px-4 py-2 text-xs text-gray08">
